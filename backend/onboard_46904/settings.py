"""
Django settings for onboard_46904 project.
...
ROOT_URLCONF = 'onboard_46904.urls'
...
WSGI_APPLICATION = 'onboard_46904.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "onboard_46904 API",
    "DESCRIPTION": "API documentation for onboard_46904 App",
    "VERSION": "v1",
}
